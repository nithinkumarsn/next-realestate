...
const Banner=({purpose,title1,title2,desc1,desc2,buttonText,linkName,imageUrl}) =>(
  <Flex flexwrap="wrap" justifyContent="center" alignItems="center" m="10">
    ...
    <Box p="5">
      ...
      <Text color="gray.500" fontSize="sm" fontWeight="medium">{desc1}</Text>
     <Button fontSize="xl">
...
export default function Home({propertyForRent,propertyForSale}) {
  ...
  <Box > 
    ...
    imageUrl="https://bayut-production.s3.eu-central-1.amazonaws.com/image/170789502/c410a37e339a48498290ce4ca3401d05">
    </Banner>
<Flex flexWrap="wrap">
{/* fetxh the properties */}
{propertyForRent.map((property) => <Property property={property} key={property.id}/>)}
 ...
 <Banner 
    ...
    linkName="/search?purpose-for-rent"
    imageUrl="https://bayut-production.s3.eu-central-1.amazonaws.com/image/170866105/5ca1465af6c9423da942a0e7d6151d38">
